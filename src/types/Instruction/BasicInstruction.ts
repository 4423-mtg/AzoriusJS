...
import type { DefineInstruction, Instruction } from "./Instruction.js";

// =============================================================
// MARK: 領域の移動
/** 領域の移動 */
export type Move = DefineInstruction<
    "move",
    {
...
// MARK: 誘発する
/** 誘発する */
export type Trigger = DefineInstruction<"trigger", {}>;

// MARK: 解決する
/** 呪文や能力を解決する。マナ能力を含む */
export type Resolve = DefineInstruction<
    "resolve",
    {
...
// MARK: 支払う
/** 支払う */
export type Pay = DefineInstruction<
    "pay",
    {
...
// MARK: カードを引く
/** カードを引く */
export type Draw = DefineInstruction<
    "draw",
    {
...
// MARK: ターンを開始する
/** ターンを開始する */
export type BeginTurn = DefineInstruction<
    "beginTurn",
    {
...
// MARK: フェイズとステップを開始する
/** フェイズとステップを開始する */
export type BeginPhaseAndStep = DefineInstruction<
    "beginPhaseAndStep",
    {
...
// MARK: ステップを開始する
/** ステップを開始する */
export type BeginStep = DefineInstruction<
    "beginStep",
    {
        step: SingleSpec<StepParameters>;
    }
...
// MARK: ダメージを与える
/** ダメージを与える */ // FIXME:
export type DealDamage = DefineInstruction<
    "dealDamage",
    {
        /** ダメージの発生源 */
...
// MARK: ライフを得る
/** ライフを得る */
export type GainLife = DefineInstruction<
    "gainLife",
    {
...
// MARK: カウンターを置く
/** カウンターを置く・得る */
export type PutCounter = DefineInstruction<
    "putCounter",
    {
        object: MultiSpec<GameObject>;
        counter: (object: GameObject) => MultiSpec<CounterOnObject>;
    }
>;

// MARK: 見る
/** 見る */
export type Look = DefineInstruction<"look", {}>;

// MARK: 束に分ける
/** 束に分ける */
export type SeparateIntoPiles = DefineInstruction<"separateIntoPiles", {}>;

// MARK: 値を選ぶ・宣言する
/** 値を選ぶ・宣言する */
export type ChooseValue = DefineInstruction<"chooseValue", {}>;

// MARK: 裏向きにする・表向きにする
/** 裏向きにする・表向きにする */
export type TurnFaceDown = DefineInstruction<"turnFaceDown", {}>;

export type TurnFaceUp = DefineInstruction<"turnFaceUp", {}>;
...
/** ターン起因処理 */
export type TurnBasedAction = DefineInstruction<"turnBasedAction", {}>;

/** 状況誘発 */ // 必要？
export type StateBasedAction = DefineInstruction<"stateBasedAction">;

/** 誘発した能力をスタックに置く */ // 必要?
export type PutTriggerdAbilitiesOnStack =
    DefineInstruction<"putTriggerdAbilitiesOnStack">;
